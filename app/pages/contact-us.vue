<template>
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-y-8 gap-x-10">
                ...
                <div class="w-full lg:w-[40%] flex flex-col bg-royal-blue text-white font-Roboto p-6 sm:p-8 lg:p-10 text-center md:text-left">
                    ...
                    <a href="/request-specialty-tours">
                        <button class="font-medium rounded-full border-2 border-white px-4 py-3 mt-6 hover:bg-white hover:text-royal-blue transition-all duration-300 ease-in-out cursor-pointer">
    ...
    <section>
        <div class="relative w-full shadow-md bg-dark-green py-6 px-4">
